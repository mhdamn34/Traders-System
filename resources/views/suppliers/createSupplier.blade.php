            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href=" {{ url('/suppliers') }} ">Close</a>
                        </li>
                    </ul>
                </div>
            </nav>
                ...
                <div class="col">
                    <form>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="businessPhone" class="form-control" id="business">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mobilePhone" class="form-control" id="mobile">
                            </div>
                        </div>
                        <div class="row mb-3">
