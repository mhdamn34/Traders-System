        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="#">Go To <span class="sr-only"></span></a>
                </li>
                <li class="nav-item">
            ...
            <div class="col">
                <form>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="businessphone" class=" form-control" id="business">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="mobilephone" class="form-control" id="mobile">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" name="faxnumber" class="form-control" id="fax">
                        </div>
                    </div>
